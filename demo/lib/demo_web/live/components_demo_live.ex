    ...
    <!-- Info banner -->
      <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p class="text-blue-800 text-sm">
          <strong>Component State Demo:</strong>
          Click cards to expand them (socket state - survives reconnect).
      ...
      <div class="mt-8 p-4 bg-gray-50 rounded-lg">
        ...
        <ul class="text-sm text-gray-600 space-y-1">
          ...
          <li>
            <strong>Socket state:</strong> <code>expanded</code>
            - survives reconnects (synced to JS client by component ID)
          </li>
