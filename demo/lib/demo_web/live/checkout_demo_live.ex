defmodule DemoWeb.CheckoutDemoLive do
  ...
  # ─────────────────────────────────────────────────────────────────
  # Validation (using imported defrx functions from Demo.Validators.CreditCard)
  # ─────────────────────────────────────────────────────────────────
                        ...
                        <div class="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div class="text-sm opacity-70">
                              {address.city}, {address.state} {address.zip}, US
                            </div>
                          </div>
                        </div>
                        <button
            ...
            <aside class="lg:sticky lg:top-5 self-start">
              ...
              <div class="mt-4 p-4 bg-base-100 rounded-lg border border-base-300">
                ...
                <ul class="text-sm text-base-content/70 space-y-1">
                  <li>
                    • Ash <code class="bg-base-200 px-1 rounded text-xs">form</code>
                    DSL for validation
                  </li>
                  <li>
                    • <code class="bg-base-200 px-1 rounded text-xs">extend_errors</code>
                    for custom messages
                  </li>
                  <li>
                    • <code class="bg-base-200 px-1 rounded text-xs">data-lavash-toggle</code>
                    class switching
                  </li>
                  <li>
                    • <code class="bg-base-200 px-1 rounded text-xs">data-lavash-visible</code>
                    show/hide
                  </li>
                  <li>
                    • <code class="bg-base-200 px-1 rounded text-xs">data-lavash-enabled</code>
                    button state
                  </li>
                  <li>
                    • Card type detection via
