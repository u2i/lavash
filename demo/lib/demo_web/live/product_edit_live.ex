defmodule DemoWeb.ProductEditLive do
  ...
  state do
    ...
    # Form binding: auto-sync "form" params → :product_params state
    # Note: "form" is the default name generated by AshPhoenix.Form
    form :product_params, from: "form"
  ...
  derived do
    ...
    # Ash changeset is derived from product + product_params
    # Only runs when product is ready (not :loading or {:error, _})
    field :changeset, depends_on: [:product, :product_params], compute: fn
      %{product: product, product_params: params} ->
