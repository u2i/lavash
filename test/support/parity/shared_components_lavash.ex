defmodule Lavash.Parity.SharedComponentsLavash do
  ...
  # splices `use Phoenix.LiveView` into this module body, so the
  # attr/slot calls generated by `components do` work directly
  # (issue #20 regression guard — do not re-add).
  use Lavash.LiveView
