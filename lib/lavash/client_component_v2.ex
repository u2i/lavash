defmodule Lavash.ClientComponentV2 do
  @moduledoc """
  A Spark-based component that renders on both server and client with optimistic updates.

  This is the next-generation ClientComponent using Spark DSL for declarative
  definition of bindings, props, calculations, and optimistic actions.
  ...
  def handle_opts(_opts) do
    quote do
      ...
      import Lavash.ClientComponent.Macros, only: [calculate: 2, optimistic_action: 3]
      ...
      @before_compile Lavash.ClientComponentV2.Compiler
