defmodule Lavash.TagEngine do
  ...
  defp handle_token([{:close, :slot, slot_name, tag_close_meta} = token | tokens], state) do
    ...
    ast =
      quote line: line do
        Lavash.TagEngine.inner_block(unquote(slot_name), do: unquote(clauses))
      end
  ...
  defp build_component_assigns(type_component, attrs, line, tag_meta, tag_close_meta, state) do
    ...
    inner_block =
      quote line: line do
        Lavash.TagEngine.inner_block(:inner_block, do: unquote(clauses))
      end
      ...
      {pattern, %{line: line}} ->
        quote line: line do
          ...
          quote generated: true do
            other ->
              Lavash.TagEngine.__unmatched_let__!(
